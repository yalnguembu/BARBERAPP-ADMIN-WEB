...
import { DefaultService, ServiceService } from "../../services";
  ...
  useEffect(() => {
    if (id) {
      ServiceService.getById({ id })
        .then((service) => {
          let theService = new Service(service);
          setName(theService.name);
          setDescription(theService.description);
          setPrice(theService.price);
          setDuration(theService.duration);
          setCategory(theService.category);
        })
        .catch((error) => {
          console.log(error);
        });
      ...
      <div className="p-8 pt-28">
        <form encType="multipart/form-data">
          <div className="flex w-full justify-between">
            ...
            <div className="mb-4">
              <SubmitButton title="Update" type="submit" onPress={update} />
            </div>
          </div>
